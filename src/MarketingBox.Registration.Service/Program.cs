...
using MarketingBox.Registration.Service.Settings;
...
namespace MarketingBox.Registration.Service
{
    ...
    {
        public const string SettingsFileName = ".marketingboxregistrationservice";
        ...
        {
            Console.Title = "MarketingBox.Registration.Service";
